 ...
 */
public class GameClient_zhyu {
    private static final Logger LOGGER = LoggerFactory.getLogger(GameClient_zhyu.class);
    ...
    public static void sendMessage(Connection connection, int cmd, Map<String, Object>dataMap) {
        ...
        System.out.println(index +" to服务端发送消息{cmd:" + cmd + ",dataMap:" + dataMap + "}");
...
//        addressMap.put("a", new InetSocketAddress("192.168.199.245", 9999));
        // 公司(本机)
//        addressMap.put("a", new InetSocketAddress("192.168.10.222", 9999));
...
//                (b[0] & 0xFF) << 24;
            ...
            public void messageArrived(Connection connection, Message msg) {
                ...
                System.out.println(index + "客户端%%%%%%%%%数据=====cmd :" + cmd + "str :" +str);
