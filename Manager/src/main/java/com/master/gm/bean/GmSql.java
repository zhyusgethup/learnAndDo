...
public enum GmSql {
    Query_Comprehensive() {
        ...
        public String getSql() {
            return "select time,server,registerUsers,avgOnlineTime,payUsersCount,payAmout,arrpu,arpu,payPermeate,ltv,totalRegisterUsers, from analysis_log.comprehensive";
        }
