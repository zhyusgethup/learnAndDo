...
//    @Override
//    public void setPlayerState(String playerName, String state) throws GmException{
...
//        String str = HttpUtil.httpPost(HttpPropertiesLoader.O_OUT_PLAYER_URL, map);
//        if(null != str) {
...
//    @Override
//    public Object outPlayer(String playerId, String playerName) throws GmException{
//            Map<String, String> map = new HashMap<>();
...
//    public static void main(String[] args) throws GmException {
//        PlayerService thisa = new PlayerService();
//        thisa.outPlayer(null,"q2,q3");
//    }
}
