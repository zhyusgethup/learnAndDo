...
public class InitTableDataCache {
    ...
    private static final Map<String,List<String>> comprehensiveData = new ConcurrentHashMap<>();
    public static void clearAll(){
        report.clear();
        rate.clear();
        nowData.clear();
        comprehensiveData.clear();
    }
    ...
    public static void setComprehensiveData(Map<String,List<String>> msg) {
        comprehensiveData.clear();
        comprehensiveData.putAll(msg);
    }
    ...
    public static Map<String,List<String>> getComprehensiveData() {
