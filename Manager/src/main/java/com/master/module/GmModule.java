 ...
 * @Description 主模块
 */
@IocBy(type = ComboIocProvider.class,args={"*js", "ioc/", "*anno", "com.master", "*tx", "*async","*jedis","*quartz"}/*,init = {"goodsComputeService","loginLogoutService","tableManager"}*/)
@Ok("json:full")
@Fail("http:500")
...
public class GmModule {
    ...
    public static final String TABLE=BASE_URL+"/table";
}
