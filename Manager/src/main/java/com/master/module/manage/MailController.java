...
import com.master.bean.web.FuncConfig;
...
public class MailController {
    ...
    //{"type":2,"param":41060001,"value":-20,"overMax":false,"param2":0,"param3":0,"createDate":"2019-03-06-20-33-34"}
    @At("/sendMail")
    ...
    public ResultBean getPlayerBaseInfo(@Param("playerName") String playerName, @Param("playerId") String playerId,
                                        @Param("funcsJson") String base64, @Param("title") String title,
        ...
        try {
            ...
            String funcsJson = new String(new BASE64Decoder().decodeBuffer(base64));
            if (null != funcsJson) {
                map.put("funcsJson", funcsJson);
            }
            if(!map.containsKey("playerName") && !map.containsKey("playerId"))
                throw new GmException("参数错误");
            Object o = HttpUtil.gameServerReturnObjectPost(HttpPropertiesLoader.O_SEND_MAIL_URL, map);
