                ...
                case 20101:
                    ...
                    switch (command) {
                        ...
                        case "guild_Join"://加入军团 1
                            sendMessage(connection, 120002, getDataMap(new Object[]{"id", 9}));
                            break;
...
//                            sendMessage(connection, 120003, getDataMap(new Object[]{"name", "惜缘"}));
                        ...
                        case "guild_AcceptJoin"://同意加入军团 1
                            sendMessage(connection, 120004, getDataMap(new Object[]{"pid", 37, "accept", true}));
                            break;
                        ...
                        case "guild_Out"://离开军团    1     注意pid是人的id   !+1
                            sendMessage(connection, 120010, getDataMap(new Object[]{"pid", 12}));
                            break;
